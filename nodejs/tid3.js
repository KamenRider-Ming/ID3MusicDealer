...
var binaryFile = function(Data) {
	...
	this.getByteAt = function(iOffset) {
		return data[iOffset + dataOffset] & 0xFF;
	};
...
var ID3fileReader = function(data, readlist) {
	data = new binaryFile(data);
	return ID3v2.readTagsFromData(data, readlist);
};

ID3module.ID3fileReader = ID3fileReader;
...
ID3v2.readTagsFromData = function(data, tags) {
	...
	console.log(ID3module._shortcuts);
...
ID3module.ID3v2 = ID3v2;


module.exports = ID3module;